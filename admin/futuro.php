...
if(isset($_GET['id_apagar']) ){
  ...
  mysqli_query($ligacao, "DELETE FROM artigos_futuro WHERE id = $id");
}
...
mysqli_query($ligacao, "INSERT INTO artigos_futuro
(titulo,texto,imagem)
VALUES
...
//guardar numa variável uma consulta à base de dados
  $consulta = mysqli_query($ligacao, "SELECT * FROM artigos_futuro ORDER BY id");

while($linha = mysqli_fetch_assoc($consulta)){
  $artigos_futuro[] = $linha;
};
    ...
    <div class="contentor">
        ...
        <div class="lista">
          ...
          <?php for($i=0;$i<count($artigos_futuro);$i++){ ?>
            ...
            <div class="item">
                <div class="lista-img">
                    <img src="../imagens/<?php echo $artigos_futuro[$i]['imagem']; ?>"></img>
                </div>
                <div class="lista-title">

                    <?php echo $artigos_futuro[$i]['titulo']; ?>
                    </a>
                </div>
                <div class="lista-botoes">
                  <div class="lista-delete">
                    <a href="futuro.php?id_apagar=<?php echo $artigos_futuro[$i]['id']; ?>">Apagar Artigo</a>
                  </div>

                  <div class="lista-edit">

                      <a href=" editar_artigo_fut.php?id=<?php echo $artigos_futuro[$i]['id']; ?>" class="botao_editar">
                        editar
                      </a>
                    </div>
                  <div class="clear">

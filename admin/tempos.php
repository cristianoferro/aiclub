...
if(isset($_GET['id_apagar']) ){
  ...
  mysqli_query($ligacao, "DELETE FROM artigos WHERE id = $id");
}
...
mysqli_query($ligacao, "INSERT INTO artigos
(titulo,texto,imagem)
VALUES
    ...
    <div class="contentor">
        ...
        <div class="lista">
          ...
          <?php for($i=0;$i<count($artigos);$i++){ ?>
            ...
            <div class="item">
                <div class="lista-img">
                    <img src="../imagens/<?php echo $artigos[$i]['imagem']; ?>"></img>
                </div>
                <div class="lista-title">

                    <?php echo $artigos[$i]['titulo']; ?>
                    </a>
                </div>
                <div class="lista-botoes">
                  <div class="lista-delete">
                    <a href="tempos.php?id_apagar=<?php echo $artigos[$i]['id']; ?>">Apagar Artigo</a>
                  </div>

                  <div class="lista-edit">
                    
                      <a href=" editar_artigo.php?id=<?php echo $artigos[$i]['id']; ?>" class="botao_editar"> 
                        editar
                      </a>
                    </div>
                  <div class="clear">

<?php
    ...
    if( count($_POST) > 0 ){
        ...
        mysqli_query($ligacao,"UPDATE artigos_app SET titulo = '$titulo' , texto = '$texto'
        WHERE id = $id ")or die();
        ...
        if( $_FILES['imagem']['error'] == 0 ){
            ...
            mysqli_query($ligacao,"UPDATE artigos_app SET imagem = '$imagem' WHERE id = $id");
    ...
    $consulta = mysqli_query($ligacao , "SELECT * FROM artigos_app WHERE id = $id");
